...
const Home: React.FC = () => {
  // Images du carrousel
  const heroImages = [
    'https://images.unsplash.com/photo-1449824913935-59a10b8d2000', // Marché animé
    'https://images.unsplash.com/photo-1558981806-ec527fa84c39?q=80&w=2070&auto=format&fit=crop', // Moto en ville
    'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1200&fit=crop&q=80', // Ville moderne
  ];
  ...
  // Annonces premium en premier, puis standard
  const annoncesTriees = [...annoncesData].sort((a, b) => (b.estPremium ? 1 : 0) - (a.estPremium ? 1 : 0));
  // Avis de décès récents (tous pour l'instant)
  const avisDeces = necrologiesData.slice(0, 3);

  return (
    <MainLayout>
      {/* HERO – Carrousel d'images + fallback noir */}
      <section
        className="relative bg-cover bg-center text-white overflow-hidden transition-all duration-1000"
        style={{
          backgroundImage: `url('${heroImages[currentImageIndex]}')`,
          backgroundColor: '#1A1A2E', // fallback noir
        }}
      >
        ...
        {/* SVG de vague SANS ligne droite finale */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* SECTION 1 : À LA UNE (Articles boostés) */}
        ...
        {/* SECTION 4 : POURQUOI DJOUGOUCITY */}
