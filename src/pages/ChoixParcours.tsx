      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div className="bg-gradient-to-r from-primary to-secondary p-6 text-white">
            ...
            <p className="text-white/90">Pour les transporteurs à l'aise avec le numérique</p>
          </div>
          <div className="p-6">
            <ul className="space-y-4 mb-6">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-dark">Choisissez votre type d'annonce et votre pack</span>
              </li>
              <li className="flex items-start gap-3">
                <ThumbsUp className="w-5 h-5 text-success shrink-0 mt-0.5" />
                <span className="text-dark">Publiez immédiatement et suivez vos contacts</span>
              </li>
            </ul>
            <Link
              to="/auth?redirect=/publier/moi-meme"
        ...
        >
          <div className="bg-gradient-to-r from-dark to-gray-800 p-6 text-white">
            ...
            <p className="text-white/90">Un agent CITransports s'occupe de tout</p>
          </div>
          <div className="p-6">
            <ul className="space-y-4 mb-6">
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                <ThumbsUp className="w-5 h-5 text-success shrink-0 mt-0.5" />
                <span className="text-dark">Payez par Mobile Money ou espèces, on publie pour vous</span>
              </li>
            </ul>
            <Link
