...
import { MapPin, Phone, Megaphone, Menu, X } from 'lucide-react';
      ...
      <div className="bg-dark text-white py-2">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center text-sm">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1"><MapPin className="w-4 h-4" /> {CONTACT.ADDRESS}</span>
            <span className="flex items-center gap-1"><Phone className="w-4 h-4" /> {CONTACT.PHONE}</span>
          </div>
          <span className="bg-secondary/20 px-3 py-1 rounded-full text-secondary font-bold">
